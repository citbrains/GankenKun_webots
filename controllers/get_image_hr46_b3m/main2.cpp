...
#include "GET_IMAGE/Image_Writer.hpp"
...
public:
    ...
    robot_camera->enable(mTimeStep*13);
	}
  ...
  void star_camera()
  {
    robot_camera->getImage();
    //image_writer.saveImage(image_writer->save_captured_image(), 100);
    robot_camera->saveImage(image_writer.save_captured_image(), 75);
  }
};
...
int main(int argc, char *argv[])
{
  ...
  //camera->enable(wb_ganken.getmTimeStep());
