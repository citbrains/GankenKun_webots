...
for x in frange(2.80,2.90,0.01):
    x_list.append(x)
for y in frange(0.000,0.100,0.01):
    y_list.append(y)

x30 = [2.860, 2.868, 2.877, 2.851]
y30 = [0.065, 0.060, 0.055, 0.070]
    ...
    while(1):
            ...
            for y in range(0,10):
                ...
                while supervisor.step(time_step) != -1:
                    ...
                    if count < 72:
                        ...
                        with open('test_3d_file_front.txt', 'a') as f:
                            for d in read_val:
                                f.write("%s\n" % d)
                    elif fg == False:
                        fg = True
                    ...
                    if count > 250 or memo_ball[0] >= 4.4:
                        ...
                        memo = str(memo_ball)
                        cnt = str(cnt_memo)
                        with open('test_ball_pos_front.txt', 'a') as f:
                            f.write(memo)
                            f.write("\n")
                            #f.write(cnt)
                            #f.write("\n")
        ...
        for m in range(0,4):
            for n in range(0,10):
                ...
                children.importMFNodeFromString(-1, f'DEF ENEMY1 GankenKun_Keypoints {{translation {x30[m]+0.007*(n+1)} {y30[m]+0.001204*(n+1)} 0.446 rotation 0 1 0 0 controller "play_motion" controllerArgs "./kick_motion0.csv"}}')
                #print("x : ",x_list[x], "y : ",y_list[y])
                player = supervisor.getFromDef('ENEMY1')
                ball.resetPhysics()
                ball_translation.setSFVec3f([3,0,0.08])
                ...
                while supervisor.step(time_step) != -1:
                    ...
                    if count < 72:
                        ...
                        with open('test_3d_file_30.txt', 'a') as f:
                            for d in read_val:
                                f.write("%s\n" % d)
                    elif fg == False:
                        fg = True
                    ...
                    if count > 250 or memo_ball[0] >= 4.4:
                        ...
                        memo = str(memo_ball)
                        cnt = str(cnt_memo)
                        with open('test_ball_pos_30.txt', 'a') as f:
                            f.write(memo)
                            f.write("\n")
                            #f.write(cnt)
                            #f.write("\n")
        ...
        for m in range(0,4):
            for n in range(0,10):
                ...
                children.importMFNodeFromString(-1, f'DEF ENEMY1 GankenKun_Keypoints {{translation {x_30[m]+0.006*(n+1)} {y30[m]-0.01039*(n+1)} 0.446 rotation 0 1 0 0 controller "play_motion" controllerArgs "./kick_motion0.csv"}}')
                #print("x : ",x_list[x], "y : ",y_list[y])
                player = supervisor.getFromDef('ENEMY1')
                ball.resetPhysics()
                ball_translation.setSFVec3f([3,0,0.08])
                ...
                while supervisor.step(time_step) != -1:
                    ...
                    if count < 72:
                        ...
                        with open('test_3d_file_-30.txt', 'a') as f:
                            for d in read_val:
                                f.write("%s\n" % d)
                    elif fg == False:
                        fg = True
                    ...
                    if count > 250 or memo_ball[0] >= 4.4:
                        ...
                        memo = str(memo_ball)
                        cnt = str(cnt_memo)
                        with open('test_ball_pos_-30.txt', 'a') as f:
                            f.write(memo)
                            f.write("\n")
                            #f.write(cnt)
                            #f.write("\n")
        ...
        for m in range(0,4):
            for n in range(0,10):
                ...
                children.importMFNodeFromString(-1, f'DEF ENEMY1 GankenKun_Keypoints {{translation {x15[m]+0.003367*(n+1)} {y15[m]+0.0125565*(n+1)} 0.446 rotation 0 1 0 0 controller "play_motion" controllerArgs "./kick_motion0.csv"}}')
                #print("x : ",x_list[x], "y : ",y_list[y])
                player = supervisor.getFromDef('ENEMY1')
                ball.resetPhysics()
                ball_translation.setSFVec3f([3,0,0.08])
                ...
                while supervisor.step(time_step) != -1:
                    ...
                    if count < 72:
                        ...
                        with open('test_3d_file_15.txt', 'a') as f:
                            for d in read_val:
                                f.write("%s\n" % d)
                    elif fg == False:
                        fg = True
                    ...
                    if count > 250 or memo_ball[0] >= 4.4:
                        ...
                        memo = str(memo_ball)
                        cnt = str(cnt_memo)
                        with open('test_ball_pos_15.txt', 'a') as f:
                            f.write(memo)
                            f.write("\n")
                            #f.write(cnt)
                            #f.write("\n")
        ...
        for m in range(0,4):
            for n in range(0,10):
                ...
                children.importMFNodeFromString(-1, f'DEF ENEMY1 GankenKun_Keypoints {{translation {x_15[m]+0.003367*(n+1)} {y30[m]-0.01255632*(n+1)} 0.446 rotation 0 1 0 0 controller "play_motion" controllerArgs "./kick_motion0.csv"}}')
                #print("x : ",x_list[x], "y : ",y_list[y])
                player = supervisor.getFromDef('ENEMY1')
                ball.resetPhysics()
                ball_translation.setSFVec3f([3,0,0.08])
                ...
                while supervisor.step(time_step) != -1:
                    ...
                    if count < 72:
                        ...
                        with open('test_3d_file_-15.txt', 'a') as f:
                            for d in read_val:
                                f.write("%s\n" % d)
                    elif fg == False:
                        fg = True
                    ...
                    if count > 250 or memo_ball[0] >= 4.4:
                        ...
                        memo = str(memo_ball)
                        cnt = str(cnt_memo)
                        with open('test_ball_pos_-15.txt', 'a') as f:
                            f.write(memo)
                            f.write("\n")
                            #f.write(cnt)
                            #f.write("\n")
