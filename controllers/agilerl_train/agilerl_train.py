...
if __name__ == "__main__":
    ...
    mutations = Mutations(
        algo=INIT_HP["ALGO"],
        no_mutation=MUTATION_PARAMS['NO_MUT'],  # Probability of no mutation
        architecture=MUTATION_PARAMS['ARCH_MUT'],  # Probability of architecture mutation
        new_layer_prob=MUTATION_PARAMS['NEW_LAYER'],  # Probability of new layer mutation
        parameters=MUTATION_PARAMS['PARAMS_MUT'],  # Probability of parameter mutation
        activation=MUTATION_PARAMS['ACT_MUT'],  # Probability of activation function mutation
        rl_hp=MUTATION_PARAMS['RL_HP_MUT'],  # Probability of RL hyperparameter mutation
        rl_hp_selection=MUTATION_PARAMS['RL_HP_SELECTION'],  # RL hyperparams selected for mutation
