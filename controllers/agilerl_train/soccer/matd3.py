...
class MATD3:
    ...
    def getAction(self, states, epsilon=0, action_mask=None, agent_mask=None, env_defined_actions=None):
            ...
            if random.random() < epsilon:
                if self.discrete_actions:
                    ...
                    # add ----->
                        ...
                        a_mask = action_mask[agent_id]['action_mask']
                        masked_action_values = np.ma.array(np.random.rand(self.action_dims[idx]), mask=a_mask)
                ...
                if self.discrete_actions:
                    ...
                    # add -----> 
                        ...
                        #action = action_values.squeeze(0).argmax().item()
                        a_mask = action_mask[agent_id]['action_mask']
                        masked_action_values = np.ma.array(action_values.cpu().data.numpy(), mask=a_mask)
